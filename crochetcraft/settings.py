"""
Django settings for crochetcraft project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'crochet/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # The directory where files will be uploaded and stored